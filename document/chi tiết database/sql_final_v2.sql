...
CREATE TABLE [shift_assignments] (
  ...
  [is_holiday_shift] BIT NOT NULL DEFAULT (0),
...
CREATE TABLE [public_holidays] (
  ...
  [holiday_type] VARCHAR(30) NOT NULL CHECK (holiday_type IN ('FEDERAL', 'STATE')),
  [state_code] VARCHAR(10),
  [pay_multiplier] DECIMAL(3,2) NOT NULL DEFAULT (1.50),
  [is_observed] BIT NOT NULL DEFAULT (1),
  [created_at] DATETIMEOFFSET(0) NOT NULL DEFAULT (SYSDATETIMEOFFSET())
)
GO

CREATE INDEX [idx_public_holidays_lookup] ON [public_holidays] ("holiday_date", "holiday_type", "state_code")
GO

INSERT INTO [public_holidays] ([holiday_name], [holiday_date], [holiday_type], [state_code], [pay_multiplier]) VALUES
('New Year''s Day', '2026-01-01', 'FEDERAL', NULL, 1.50),
('Martin Luther King, Jr. Day', '2026-01-19', 'FEDERAL', NULL, 1.50),
('Presidents'' Day', '2026-02-16', 'FEDERAL', NULL, 1.50),
('Memorial Day', '2026-05-25', 'FEDERAL', NULL, 1.50),
('Independence Day', '2026-07-04', 'FEDERAL', NULL, 1.50),
('Labor Day', '2026-09-07', 'FEDERAL', NULL, 1.50),
('Columbus Day', '2026-10-12', 'FEDERAL', NULL, 1.50),
('Veterans Day', '2026-11-11', 'FEDERAL', NULL, 1.50),
('Thanksgiving Day', '2026-11-26', 'FEDERAL', NULL, 1.50),
('Christmas Day', '2026-12-25', 'FEDERAL', NULL, 1.50),
('Cesar Chavez Day', '2026-03-31', 'STATE', 'CA', 1.50),
('Kamehameha Day', '2026-06-11', 'STATE', 'HI', 1.50)
GO
